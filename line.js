class Line {
  ...
  async loadCSV(file) {
    ...
    this.bins = this.line.sort((a, b) => d3.ascending(a.cat, b.cat));
...
async function main() {
  let c = { div: '#gline', width: 1000, height: 800, top: 30, left: 50, bottom: 50, right: 30 };

  let app = new Line(c);

  await app.loadCSV('dadobit.csv');
